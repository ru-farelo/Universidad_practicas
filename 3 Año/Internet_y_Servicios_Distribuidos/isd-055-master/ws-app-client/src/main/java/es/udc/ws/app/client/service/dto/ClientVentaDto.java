...
public class ClientVentaDto {
    ...
    public ClientVentaDto() {
    }

    public ClientVentaDto(Long idEntrada ,String correoUsuario, String tarjetaCredito4digitos, LocalDateTime fecha_de_compra,int unidadesAComprar,  Long partidoId) {
    ...
    public String getTarjetaCredito4digitos() {
        ...
        for (int i = 0; i < tarjetaCredito4digitos.length()-4; i++) {
            tarjetaCredito4digitosOculto += "*";
        }
